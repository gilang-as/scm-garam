                    ...
                    <table class="table table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                          <a class="btn btn-success" href="<?=$domain?>garam.php?halaman=ubah&id=<?=$row["id"]?>">Ubah</a>
                          <a class="btn btn-danger" href="<?=$domain?>garam.php?halaman=hapus&id=<?=$row["id"]?>">Hapus</a>
                          </td>
                        </tr>
                      <?php $no++; } ?>
                      </tbody>
